                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td align="center" style="padding-bottom: 15px;">
                                        <!-- Logo en el footer también con URL directa -->
                                        <img src="https://drive.google.com/uc?export=view&id=1I_Wb8rN_qhM5DvIa1oatC21DYhiKAjDN"
                    ...
                    <tr>
                        <td class="email-content" style="padding: 35px 30px; font-size: 16px; background: #ffffff;">
                            ...
                            <p
                                ...
                                Estimado/a <strong>{{ $primer_nombre }} {{ $primer_apellido }}</strong>,</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                style="margin: 30px 0;">
                                <tr>
                                    <td align="center" class="estado estado-{{ str_replace(' ', '-', $estado) }}"
                                    ...
                                    @if ($estado == 'Radicado') linear-gradient(135deg, #0c2b5a, #1678c2)
