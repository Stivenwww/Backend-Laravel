                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td align="center" style="padding-bottom: 15px;">
                                        <img src="https://drive.google.com/uc?export=view&id=1rp5f03oc4mrEUA6VHF87ziUjM7oiyC5H"
                                ...
                                <tr>
                                    <td align="center">
                                        <h1
                                            ...
                                            Notificación de Solicitud de Homologación</h1>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td class="email-content" style="padding: 35px 30px; font-size: 16px; background: #ffffff;">
                            ...
                            <p
                                ...
                                Estimada <strong>Secretaria</strong>,</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td align="center"
                                        class="estado estado-{{ str_replace(' ', '-', $datos['estado']) }}"
                                        style="text-align: center; font-size: 18px; font-weight: 600; padding: 20px 15px; border-radius: 16px; color: #ffffff; box-shadow: 0 8px 20px rgba(0, 0, 0, 0.15); background:
                                            ...
                                            <tr>
                                                <td width="50%" valign="top"
                                                    ...
                                                    <span
                                                        ...
                                                        completo:</span>
                                                    <span
                                                        style="font-size: 16px; background-color: rgba(255, 255, 255, 0.7); padding: 8px 12px; border-radius: 6px; border-left: 3px solid #1678c2; display: block;">{{ $datos['primer_nombre'] }}
                                                        {{ $datos['segundo_nombre'] }} {{ $datos['primer_apellido'] }}
                                                        {{ $datos['segundo_apellido'] }}</span>
                                                </td>
                                                <td width="50%" valign="top"
                                                    ...
                                                    <span
                                                        ...
                                                        electrónico:</span>
                                                    <span
                                                        style="font-size: 16px; background-color: rgba(255, 255, 255, 0.7); padding: 8px 12px; border-radius: 6px; border-left: 3px solid #1678c2; display: block;">{{ $datos['email'] }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="50%" valign="top"
                                                    ...
                                                    <span
                                                        ...
                                                        destino:</span>
                                                    <span
                                                        style="font-size: 16px; background-color: rgba(255, 255, 255, 0.7); padding: 8px 12px; border-radius: 6px; border-left: 3px solid #1678c2; display: block;">{{ $datos['programa_destino'] }}</span>
                                                </td>
                                                <td width="50%" valign="top"
                                                    style="padding-left: 10px; padding-bottom: 15px;">
                                                    <span
                                                        ...
                                                        estudios:</span>
                                                    <span
                                                        style="font-size: 16px; background-color: rgba(255, 255, 255, 0.7); padding: 8px 12px; border-radius: 6px; border-left: 3px solid #1678c2; display: block;">{{ $datos['finalizo_estudios'] }}</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td width="50%" valign="top"
                                                    ...
                                                    <span
                                                        ...
                                                        de solicitud:</span>
                                                    <span
                                                        style="font-size: 16px; background-color: rgba(255, 255, 255, 0.7); padding: 8px 12px; border-radius: 6px; border-left: 3px solid #1678c2; display: block;">{{ $datos['fecha_solicitud'] }}</span>
                                                </td>
                                                <td width="50%" valign="top"
                                                    style="padding-left: 10px; padding-bottom: 15px;">
                        ...
                        <td class="email-footer"
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td align="center" style="padding-bottom: 20px;">
                                        <p
                                            style="font-size: 14px; color: rgba(255, 255, 255, 0.7); text-align: center; margin-bottom: 5px;">
                                            Este es un mensaje automático del Sistema de Homologaciones de la
                                            Universidad Autónoma del Cauca.</p>
                                        <p
                                            style="font-size: 14px; color: rgba(255, 255, 255, 0.7); text-align: center; margin-top: 0;">
                                            Por favor, no responda a este correo. Para soporte, comuníquese con el
