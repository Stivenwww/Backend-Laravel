                ...
                <table class="email-container" width="650" cellpadding="0" cellspacing="0" border="0" style="max-width: 650px; margin: 0 auto; background: #ffffff; border-radius: 20px; box-shadow: 0 12px 35px rgba(12, 43, 90, 0.15); overflow: hidden;">
                    ...
                    <tr>
                        <td class="email-header" style="background: linear-gradient(135deg, #0c2b5a, #0a4c8b); text-align: center; padding: 35px 20px; position: relative;">
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td align="center">
                                        <h1 style="font-family: 'Atkinson Hyperlegible', Arial, sans-serif; font-size: 28px; font-weight: 700; margin: 0; padding: 12px 20px; color: #ffffff; text-align: center; background-color: rgba(0, 0, 0, 0.15); border-radius: 12px; display: inline-block; box-shadow: 0 6px 12px rgba(0, 0, 0, 0.2);">Credenciales de Acceso</h1>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td class="email-content" style="padding: 35px 30px; font-size: 16px; background: #ffffff;">
                            <!-- GREETING -->
                            <p style="font-size: 20px; margin-bottom: 25px; color: #0c2b5a; font-weight: 500; border-bottom: 2px solid rgba(12, 43, 90, 0.1); padding-bottom: 12px;">Estimado/a <strong>Aspirante</strong>,</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 30px 0;">
                                <tr>
                                    <td style="background-color: rgba(22, 120, 194, 0.05); padding: 25px; border-radius: 16px; font-size: 16px; line-height: 1.7; border-left: 5px solid #1678c2; box-shadow: 0 6px 16px rgba(0, 0, 0, 0.05);">
                                        Le informamos que se han generado sus credenciales de acceso a la plataforma de homologaciones de la Universidad Autónoma del Cauca.
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin-top: 35px; background-color: #f9fafc; padding: 30px; border-radius: 16px; box-shadow: 0 8px 25px rgba(12, 43, 90, 0.08); border: 1px solid #e0e7ff;">
                                <tr>
                                    <td>
                                        <h3 style="margin-top: 0; color: #0c2b5a; border-bottom: 2px solid #1678c2; padding-bottom: 12px; font-size: 20px; font-family: 'Atkinson Hyperlegible', Arial, sans-serif;">Sus Credenciales</h3>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td width="100%" valign="top" style="padding-right: 10px; padding-bottom: 15px;">
                                                    <span style="font-weight: 600; color: #0c2b5a; display: block; margin-bottom: 6px; font-size: 14px;">Email:</span>
                                            ...
                                            <tr>
                                                <td width="100%" valign="top" style="padding-right: 10px; padding-bottom: 15px;">
                                                    <span style="font-weight: 600; color: #0c2b5a; display: block; margin-bottom: 6px; font-size: 14px;">Contraseña:</span>
                                                    <span style="font-size: 16px; background-color: rgba(255, 255, 255, 0.7); padding: 8px 12px; border-radius: 6px; border-left: 3px solid #1678c2; display: block;">{{ $password }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin: 30px 0;">
                                <tr>
                                    <td style="font-size: 16px; line-height: 1.7; color: #2c3e50;">
                                        <p style="margin-bottom: 15px;">Por favor, ingrese a la plataforma y valide sus credenciales.</p>
                                        <p style="margin-bottom: 15px;">Si tiene alguna duda, no dude en contactarnos.</p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                ...
                                <tr>
                                    <td align="center" style="padding-bottom: 20px;">
                                        ...
                                        <p style="margin: 5px 0; font-size: 15px; color: #ffffff; font-weight: 600;">Equipo de Soporte de Homologaciones</p>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" style="padding-bottom: 20px;">
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td style="padding: 0 10px;">
                                                    <a href="#" style="color: #a0c6ff; text-decoration: none; font-size: 14px;">Portal Estudiantil</a>
                                                </td>
                                                <td style="padding: 0 10px;">
                                                    <a href="#" style="color: #a0c6ff; text-decoration: none; font-size: 14px;">Programas Académicos</a>
                                                </td>
                                                <td style="padding: 0 10px;">
                                                    <a href="#" style="color: #a0c6ff; text-decoration: none; font-size: 14px;">Contacto</a>
                                                </td>
                                                <td style="padding: 0 10px;">
                                                    <a href="#" style="color: #a0c6ff; text-decoration: none; font-size: 14px;">Ayuda</a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
