                    ...
                    <tr>
                        <td class="email-content" style="padding: 35px 30px; font-size: 16px; background: #ffffff;">
                            ...
                            <p
                                ...
                                Estimado/a <strong>Aspirante</strong>,</p>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td
                                        ...
                                        Le informamos que se han generado sus credenciales de acceso a la plataforma de
                                        homologaciones de la Universidad Autónoma del Cauca.
                                    </td>
                                </tr>
                            </table>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <td width="100%" valign="top"
                                                    ...
                                                    <span
                                                        style="font-weight: 600; color: #0c2b5a; display: block; margin-bottom: 6px; font-size: 14px;">Email:</span>
                                                    <span
                                            ...
                                            <tr>
                                                <td width="100%" valign="top"
                                                    style="padding-right: 10px; padding-bottom: 15px;">
                                                    <span
                                                        style="font-weight: 600; color: #0c2b5a; display: block; margin-bottom: 6px; font-size: 14px;">Contraseña:</span>
                                                    <span
                                                        style="font-size: 16px; background-color: rgba(255, 255, 255, 0.7); padding: 8px 12px; border-radius: 6px; border-left: 3px solid #1678c2; display: block;">{{ $password }}</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                ...
                                <tr>
                                    <td style="font-size: 16px; line-height: 1.7; color: #2c3e50;">
                                        <p style="margin-bottom: 15px;">Por favor, ingrese a la plataforma y valide sus
                                            credenciales.</p>
                                        <p style="margin-bottom: 15px;">Si tiene alguna duda, no dude en contactarnos.
                                        </p>
                                    </td>
                                </tr>
                            </table>
